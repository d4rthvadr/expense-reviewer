...
export default function LandingPage() {
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
        ...
        <section className="mb-8">
          ...
          <ul className="space-y-4">
            <li className="flex items-center">
              ...
              <p className="ml-2">Organize expenses by categories and tags.</p>
            </li>
            <li className="flex items-center">
              <span className="text-blue-500 font-bold">✔</span>
      ...
      <footer className="row-start-3 flex gap-[24px] flex-wrap items-center justify-center bg-gray-800 text-white p-6 text-center">
        <a
        ...
        <p className="mt-4">
          &copy; 2025 Expense Reviewer. All rights reserved.
        </p>
      </footer>
    </div>
  );
